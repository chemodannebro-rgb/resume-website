...
const ParticleWave: FC<ParticleWaveProps> = ({ className = '' }) => {
  ...
  const getBackgroundColor = (theme: string) => {
    return theme === 'dark'
      ? new THREE.Color(0x111009)
      : new THREE.Color(0xffffff)
  }

  // Particle colors: dark text #1C1917 on light / light text #F0EBE0 on dark
  const getParticleColor = (theme: string) => {
    return theme === 'dark'
      ? new THREE.Vector3(240 / 255, 235 / 255, 224 / 255) // #F0EBE0
      : new THREE.Vector3(28 / 255, 25 / 255, 23 / 255)    // #1C1917
  }
